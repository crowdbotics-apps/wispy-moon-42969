"""
Django settings for wispy_moon_42969 project.
...
ROOT_URLCONF = 'wispy_moon_42969.urls'
...
WSGI_APPLICATION = 'wispy_moon_42969.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_moon_42969 API",
    "DESCRIPTION": "API documentation for wispy_moon_42969 App",
    "VERSION": "v1",
}
